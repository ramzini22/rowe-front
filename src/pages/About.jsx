  ...
  return (
    <main>
      ...
      <section className='sec-14 mb-custom'>
        ...
        <Container>
          <h6 className='mt-3'>Мы любим смазочные материалы. Наша миссия: высочайшая продуктивность и энтузиазм, который оставляет без ответа только один вопрос: «Как нам стать ещё лучше?». Мы вкладываем в наши первоклассные моторные масла знания и душу и предлагаем клиентам индивидуальные продукты для автомобилей и промышленности. Именно поэтому мы ставим себе на службу все, что выходит за пределы возможного, стремясь добиться максимальных результатов.</h6>
        </Container>
      </section>
        ...
        <section className='sec-15 mb-custom'>
          <Row className='gx-4 gx-xl-5 align-items-center'>
            <Col xs={12} lg={7}>
              ...
              <p>Уже более 10 лет компания ROWE создаёт свои смазочные материалы в том числе на гоночной трассе. В «лаборатории на колёсах» специалисты разрабатывают новые продукты, оптимизируют старые формулы и делают то, что невозможно повторить ни в одной лаборатории мира: тесты в экстремальных полевых условиях, причём с отличным результатом. Ведь износ коробки передач — одна из тех сложностей трассы Нордшляйфе, которые двигают прогресс в нашей отрасли.</p>
            </Col>
